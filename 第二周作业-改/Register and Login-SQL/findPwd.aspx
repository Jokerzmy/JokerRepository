...
<body>
    ...
    <div id="step_2" runat="server" visible="false">
        请回答下列密保问题：<br />
        Q1:<asp:Label ID="question1" runat="server"></asp:Label><br />
        答案：<asp:TextBox ID="answer1" runat="server"></asp:TextBox><br />
        Q2:<asp:Label ID="question2" runat="server"></asp:Label><br />
        答案：<asp:TextBox ID="answer2" runat="server"></asp:TextBox><br />
        Q3:<asp:Label ID="question3" runat="server"></asp:Label><br />
